...
public class QbKey
{
	...
	public static bool operator ==(QbKey key, string str)
	{
		bool isNull1 = object.Equals(key, null);
		bool isNull2 = object.Equals(str, null);

		return ((isNull1 && isNull2) || (!isNull1 && !isNull2 && key.Crc == Create(str).Crc));
	}
	public static bool operator !=(QbKey key, string str)
	{
		return (!(key == str));
